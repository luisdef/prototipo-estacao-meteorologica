...
<div class="estacao-tempo">
    ...
    <div class="temperatura">
        ...
        <a><img class="icon-termometro" src="assets/img/weather-icons/celsius.png" alt="celcius"></a>
        <p>
            <?php
    ...
    <div class="humidade">
        ...
        <a><img class="icon-umidade" src="assets/img/weather-icons/humidity.png" alt="umidade"></a>
        <p>
            <?php
    ...
    <div class="pressao">
        ...
        <a><img class="icon-pressao" src="assets/img/weather-icons/pressure.png" alt="pressao"></a>
        <p>
            <?php
    ...
    <div class="lum">
        ...
        <a><img class="icon-lum" src="assets/img/weather-icons/lamp.png" alt="pressao"></a>
        <p>
            <?php
